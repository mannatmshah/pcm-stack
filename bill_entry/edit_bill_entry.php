...
function check()
{
	...
	var bill_date=document.getElementById("bill_date").value;
		...
		var billdate_parts =bill_date.split('-');
		var voudate_parts=voucher_date.split('-');
		var bill_dt=new Date(billdate_parts[2],billdate_parts[1]-1, billdate_parts[0]);
		var vou_dt=new Date(voudate_parts[2],voudate_parts[1]-1,voudate_parts[0]);

		if(bill_dt >vou_dt){
			alert("Bill Date can not be greater then Voucher Date");	
			document.getElementById("bill_date").focus();
			return false;			
		}
                        ...
                        <tr>
							...
							<?php 	if($req_disp!='child'){ 
										if($req_src=='search') { 
											...
											echo "<a href='bill_search.php?src=search&search_bill_entry_id=$search_bill_entry_id&search_bill_number=$search_bill_number&vou_end_date=$vou_end_date&vou_start_date=$vou_start_date&bill_end_date=$bill_end_date&bill_start_date=$bill_start_date&search_buyer_account_code=$search_buyer_code&search_supplier_account_code=$search_supplier_code'>Back</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
											} else {
...
<!--    	<th align="left">LR Date </th>
		...
		-->
		<input type='hidden' name="lr_date" id="lr_date" value="" >		
	</tr>
	<tr>
...
<?php /*	
	...
	*/
	?>
	<input type='hidden' name="agent" id="agent" value='33' >
	<tr>
			...
			<table  cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse">
				<tr cellpadding="0" cellspacing="0" border="0">
					<td cellpadding="0" cellspacing="0" border="0">	
						<input type="text" name="gross_amount" size="6"  value="<?php echo zeroToBlank($rs['gross_amount']); ?>"  id="gross_amount" onblur="grossAmountOnChange()" />
					</td>
					<td cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
		...
		<table  cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse">
				<tr cellpadding="0" cellspacing="0" border="0">
					<td cellpadding="0" cellspacing="0" border="0">			
						<input type="text" name="discount_percentage" size="6" value="<?php echo zeroToBlank($rs['discount_percentage']); ?>" onfocusout="discountCalculate()" id="discount_percentage" />
		...
		<td><input disabled  type="text" name="discount_amount" size="6" value="<?php echo zeroToBlank($rs['discount_amount']); ?>" id="discount_amount" /> (Calculated)</td>
	</tr>
    ...
    <tr>
    	...
    	<td>
			<table  cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse">
				<tr cellpadding="0" cellspacing="0" border="0">
					<td cellpadding="0" cellspacing="0" border="0">	
						<input type="text" name="deduction_amount" size="6" value="<?php echo zeroToBlank($rs['deduction_amount']); ?>" id="deduction_amount" onblur="deductionCheck()" />
					</td>
					<td cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
		...
		<table  cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse">
				<tr cellpadding="0" cellspacing="0" border="0">
					<td cellpadding="0" cellspacing="0" border="0">	
						<input type="text" name="additional_amount" size="6" value="<?php echo zeroToBlank($rs['additional_amount']); ?>" id="additional_amount" onblur="additionCheck()"  />
						</td>
					<td cellpadding="0" cellspacing="0" border="0">
		...
		<td><input disabled type="text" name="net_amount" size="6"  value="<?php echo zeroToBlank($rs['net_amount']); ?>" id="net_amount" /> (Calculated) </td>
	...
	<tr>
			...
			<table  cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse">
				<tr cellpadding="0" cellspacing="0" border="0">
					<td cellpadding="0" cellspacing="0" border="0">	
						...
						<input type="text" name="gst_percent" size="6" id="gst_percent" value="<?php echo zeroToBlank($rs['gst_percent']); ?>"  onblur="gstCalculate()" />
					</td>
					<td cellpadding="0" cellspacing="0" border="0">
		...
		<td><input disabled type="text" name="gst_amount" size="6"  value="<?php echo zeroToBlank($rs['gst_amount']); ?>" id="gst_amount" /> (Calculated) </td>
	...
	<th align="left">Round Off </th>
		<td>
			<table  cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse">
				<tr cellpadding="0" cellspacing="0" border="0">
					<td cellpadding="0" cellspacing="0" border="0">	
						<input type="text" name="round_off" size="6" id="round_off" value="<?php echo zeroToBlank($rs['round_off']); ?>" onblur="roundOffCheck()" />
						</td>
					<td cellpadding="0" cellspacing="0" border="0">
		...
		<td><input disabled type="text" name="bill_amount" size="6" value="<?php echo zeroToBlank($rs['bill_amount']); ?>" id="bill_amount" /> (Calculated)</td>		
 ...
 <!--       <td><img src="../images/upload_2.png" alt="no image" id="prev0" style="width:25px;height:25px;" name="prev_img1[]" />
		...
		if($rs['supporting_doc']!="") { ?>
			<a href='<?php echo $web_path; ?>bill_entry/upload/<?php echo $rs['supporting_doc']; ?>'>Bill Supporting Doc</a>
			<?php if($req_disp!='child') { ?>
                	    ...
                	    <tr>
                    	    <td >
							   ...
							   <?php if($req_disp!='child') { ?>
								...
								<?php } else {
									echo " <br><br>
									<h3> Bill Edit and delete not Allowed because one or more Payment is attached to it. </h3>";
								}
								 ?>	

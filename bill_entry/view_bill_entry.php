...
<tr>
  ...
  <tr>
    <td height="326" valign="top"><table width="100%" style="margin-top:0px" align="center" cellpadding="0" cellspacing="0" border="0">
            ...
            <table width="100%"><tr><td><h3>View Bill Entry :</h3></td>
            	<td align="right"></td>
            </tr>
            </table>
            </div>
...
?>
	...
	<tr>
        ...
        <td width="174" align="left"><input disabled type="text" name="voucher_number" value="<?php echo $rs['voucher_number']; ?>" id="voucher_number" size="10"></td>

    	<th align="left">Voucher Date <span class="astrik">*</span></th>
    	<td align="left"><input disabled type="text" name="voucher_date" class="datepick" value="<?php echo rev_convert_date($rs['voucher_date']); ?>" id="voucher_date" size="8" /></td>
	</tr>
	<tr>
    ...
    <tr>
    	...
    	<td><input disabled type="text" name="bill_number" value="<?php echo $rs['bill_number']; ?>" size="10" id="bill_number" /></td>

    	<th align="left">Bill Date <span class="astrik">*</span></th>
    	<td><input disabled type="text" name="bill_date" class="datepick" value="<?php echo rev_convert_date($rs['bill_date']); ?>" id="bill_date" size="8" /></td>
	</tr>
	<tr>
    ...
    <tr>
    	...
    	<td><input disabled type="text" name="lr_number" value="<?php echo $rs['lr_number']; ?>" size="10" id="lr_number" /></td>

    	<th align="left">LR Date </th>
    	<td><input disabled type="text" name="lr_date" class="datepick" value="<?php echo rev_convert_date($rs['lr_date']); ?>" id="lr_date" size="8" /></td>
	</tr>
	<tr>
    ...
    <tr>
		...
		<td>
        	<select disabled name="buyer_account_code" id="buyer_account_code">
            	<option value="">--Select--</option>
                <?php
	...
	<th align="left">Transport Name <span class="astrik">*</span></th>
		...
		<td>
        	<select disabled name="transport_name" id="transport_name">
            	<option value="">--Select--</option>
                <?php
		...
		<td>
        	<select disabled name="agent" id="agent">
            	<option value="">--Select--</option>
                <?php
			...
			<table  cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse">
				<tr cellpadding="0" cellspacing="0" border="0">
					<td cellpadding="0" cellspacing="0" border="0">	
						<input type="text" disabled name="gross_amount" size="6"  value="<?php echo $rs['gross_amount']; ?>"  id="gross_amount" onblur="grossAmountOnChange()" />
					</td>
					<td cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
		...
		<table  cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse">
				<tr cellpadding="0" cellspacing="0" border="0">
					<td cellpadding="0" cellspacing="0" border="0">			
						<input type="text" disabled name="discount_percentage" size="6" value="<?php echo $rs['discount_percentage']; ?>" onfocusout="discountCalculate()" id="discount_percentage" />
    ...
    <tr>
    	...
    	<td>
			<table  cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse">
				<tr cellpadding="0" cellspacing="0" border="0">
					<td cellpadding="0" cellspacing="0" border="0">	
						<input type="text" disabled name="deduction_amount" size="6" value="<?php echo $rs['deduction_amount']; ?>" id="deduction_amount" onblur="deductionCheck()" />
					</td>
					<td cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
		...
		<table  cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse">
				<tr cellpadding="0" cellspacing="0" border="0">
					<td cellpadding="0" cellspacing="0" border="0">	
						<input type="text" disabled name="additional_amount" size="6" value="<?php echo $rs['additional_amount']; ?>" id="additional_amount" onblur="additionCheck()"  />
						</td>
					<td cellpadding="0" cellspacing="0" border="0">
			...
			<table  cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse">
				<tr cellpadding="0" cellspacing="0" border="0">
					<td cellpadding="0" cellspacing="0" border="0">	
						...
						<input type="text" disabled name="gst_percent" size="6" id="gst_percent" value="<?php echo $rs['gst_percent']; ?>"  onblur="gstCalculate()" />
					</td>
					<td cellpadding="0" cellspacing="0" border="0">
	...
	<th align="left">Round Off </th>
		<td>
			<table  cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse">
				<tr cellpadding="0" cellspacing="0" border="0">
					<td cellpadding="0" cellspacing="0" border="0">	
						<input type="text" disabled name="round_off" size="6" id="round_off" value="<?php echo $rs['round_off']; ?>" onblur="roundOffCheck()" />
						</td>
					<td cellpadding="0" cellspacing="0" border="0">

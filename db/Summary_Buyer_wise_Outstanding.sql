-- Query not final need to work on spliting bill total from payment total here if part payment is done twice then bill total is doubled

SELECT buy_firm_name ,supp_firm_name
,  BILL_AMT
,  Discount
,  Deduction
, GR
...
GROUP BY
  buy_firm_name ,supp_firm_name) AS comp
  -- buy_firm_name
  -- , supp_firm_name
  -- , bill_date
  -- , bill_number
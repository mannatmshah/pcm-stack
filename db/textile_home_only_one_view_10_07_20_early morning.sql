...
/*Table structure for table `view_supplier_1` */

DROP TABLE IF EXISTS `view_supplier_1`;

/*!50001 DROP VIEW IF EXISTS `view_supplier_1` */;
/*!50001 DROP TABLE IF EXISTS `view_supplier_1` */;

/*!50001 CREATE TABLE `view_supplier_1` (

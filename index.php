...
<title>Devendra Textiles :  Login</title>
...
<table width="1000" border="0" align="center" style="border:1px solid #e5f1f8;background-color:#FFFFFF">
  ...
  <tr>
    <td height="326" align='center' valign="top"><table width="100%" align="center" cellpadding="0" cellspacing="0" border="1">
                        <tr>
				 ...
				 <?php if(isset($_REQUEST['msg'])) {
					...
					<h1 >	<img height='100' width='300' src="<?php echo $web_path; ?>images/dt_logo_name.png" alt="Devendra Textiles">
				<!-- Devendra Textiles -->
			</h1>
            </div>

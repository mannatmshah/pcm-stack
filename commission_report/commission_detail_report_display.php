...
if($comm_report_type=="Payment Wise"){
 ...
 $sql_pay.= " ORDER by bill_date ,voucher_date ) AS t1
         $query_join 
...
$sql_pay.=" order by payment_entry_vou_date ASC, payment_entry_id ASC  ) AS t2 
        ON t1.bill_entry_id=t2.t2_bill_entry_id order by t2.payment_entry_vou_date, t1.voucher_date ASC,  bill_date ASC, bill_number ASC  ";
} else {
  $sql_pay.=" order by payment_entry_vou_date ASC, payment_entry_id ASC  ) AS t2 
  ON t1.bill_entry_id=t2.t2_bill_entry_id order by   bill_date ASC, bill_number ASC ,create_date asc ,payment_entry_id asc ";
...
/*
    ...
    */
    ...
    echo "<tr><td colspan='3'><BR></td><td><BR></td><td>&nbsp;</td><td colspan='4' align='center' ></td></tr>";
    echo "<tr><td colspan='9' align='center'> For any queries please contact Pritesh Shah - 09977890552 </td></tr>";
    echo "<tr><td colspan='3'><BR></td><td><BR></td><td>&nbsp;</td><td colspan='4' align='center' ></td></tr>";
    //echo "</table></td></tr>";
    //echo "<tr> <td colspan='9'> <table border='1'>";

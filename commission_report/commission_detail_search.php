...
<script>
  function comm_detail_report_submit(){
      if(document.getElementById('supplier_account_code').value==""){
        ...
        document.getElementById('comm_detail_report').action='commission_detail_search.php';
  ...
  function excelDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){      
      document.getElementById('comm_detail_report').action='commission_detail_report_display_xls.php';
      document.getElementById('comm_detail_report').target="_self";
      document.getElementById('comm_detail_report').submit();
    }else{
  ...
  function pdfDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){    
        document.getElementById('comm_detail_report').action='commission_detail_report_display_print.php';
          ...
          <td valign="top">
            <div class="content_padding">
              <div class="content-header">
                <table width="100%" border='0'><tr><td><h3>Commission Detail Report :</h3></td></tr></table>
              </div>
              ...
              <table class="tbl_border">
                <tr>
                  ...
                  <td>
                      <select onchange='downloadLock()' name="comm_report_type" id="comm_report_type">
                            <?php
                                $arr=array('Bill Wise','Payment Wise');
                ...
                <tr>
                  <th  align="left">  Start Date </th>
                    <td><input type="text"  onChange="validatedate_format(this);downloadLock()" name="start_date" class="datepick" size="8" id="bill_start_date" value="<?php echo $disp_start_date ?>" /></td>

                  <th align="left"> End Date </th>

                  <td><input type="text"  onChange="validatedate_format(this);downloadLock()" name="end_date" class="datepick" size="8" id="bill_end_date" value="<?php echo $disp_end_date ?>" /> &nbsp;&nbsp; <input  type="button" class="date-button" onclick="changeDates()" name="changeDate" id="changeDate" value="Previous Year" /></td>
                ...
                <tr>
                  <td colspan='4'> <span class="astrik">*</span> Report for Selected Supplier</td>
                </tr>

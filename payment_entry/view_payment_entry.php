...
function pdfDownLoad(){
        ...
        document.getElementById('view_payment').action='view_payment_entry_print.php';
        document.getElementById('view_payment').target="print_popup";
        window.open('','print_popup','menubar=no,addressbar=no, width=1000,height=800,resizable=yes,toolbar=no,status=no');
        document.getElementById('view_payment').submit();
...
<table width="770"' border='0'> <tr> <td align='right'>
